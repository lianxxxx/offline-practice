<section id="menu" class="relative pt-20 pb-40 px-6 overflow-hidden ">
    ...
    <div class="max-w-300 mx-auto">
        ...
        <div class="grid grid-cols-1  md:grid-cols-3 gap-6 md:gap-0 rounded-xl overflow-hidden md:border md:border-black/8 ">
            @foreach ($drinks as $idx => $drink)
                <div class="group relative overflow-hidden transition-all duration-300 cursor-pointer md:shadow-sm rounded-xl md:rounded-none">
