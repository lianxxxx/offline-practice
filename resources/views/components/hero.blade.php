<section id="hero" class="relative min-h-screen flex items-center overflow-hidden px-6">
    ...
    <div class="max-w-300 mx-auto w-full pt-28 pb-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div class="animate-fade-up">
            ...
            <p class="font-sans text-[1.05rem] font-light text-grind-primary opacity-80 max-w-100leading-relaxed mb-10">
            ...
            <div class="flex flex-wrap items-center gap-4">
              ...
              <a href="#features"
   class="inline-flex items-center gap-2 font-sans text-sm text-stone-600 hover:text-[#c8a97e] transition-all duration-200 no-underline group">
    Learn more
