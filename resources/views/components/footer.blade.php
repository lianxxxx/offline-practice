    ...
    <div class="max-w-300q mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 mb-16">
         ...
         class="h-6 w-6 object-contain">
                ...
                <p class="font-sans text-sm text-grind-primary opacity-50 leading-relaxed max-w-70 mb-5">
            ...
            {{-- Links --}}
            <div>
                <p class="font-mono-grind text-[0.65rem] tracking-[0.2em] text-grind-muted uppercase mb-5">Pages</p>
                <ul class="list-none flex flex-col gap-3">
                    @foreach(['Home' => '#hero', 'Menu' => '#menu', 'About' => '#features', 'Contact' => '#contact'] as $label => $href)
                        <li>
                            <a href="{{ $href }}"
                               class="font-sans text-sm text-grind-accent opacity-50 hover:opacity-100 hover:text-grind-primary no-underline transition-all duration-200">
                                {{ $label }}
                            </a>
                        </li>
                    @endforeach
            ...
            {{-- Contact --}}
            <div>
                <p class="font-mono-grind text-[0.65rem] tracking-[0.2em] text-grind-muted uppercase mb-5">Find Us</p>
                <div class="flex flex-col gap-3">
                    <p class="font-sans text-sm text-grind-primary opacity-50 leading-relaxed">Bacnotan, La Union<br>Philippines</p>
